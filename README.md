...
The spectator background uses `public/assets/medium-earth-clean.png`, generated by `scripts/build-clean-map.py`. It is intentionally neutral geography only; replay state is rendered dynamically on top.
